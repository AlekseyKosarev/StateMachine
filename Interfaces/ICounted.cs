namespace StateMachine.Interfaces
{
    ...
    /// <remarks>
    ///     <para>
    ///         This interface is used to implement reference counting for states. A state remains active as long as its
    ///         reference count is greater than zero.
    ///     </para>
    ///     <para>
    ///         <b>Behavior:</b> Each call to <see cref="IncrementCount" /> increases the count, and each call to
    ///         <see cref="DecrementCount" /> decreases it. The state is fully deactivated only when the count reaches zero.
    ///     </para>
    /// </remarks>
